...
<body class="pt-5">
	...
	<div class="container">
		<div class="row">
			<table width="100%">
				<tr>
					<td align="left"><a href="./deleteCart.jsp?cartId=<%=cartId %>" class="btn btn-danger">장바구니 비우기</a></td>
					<td align="right">
					<%
		...
		<div style="padding-top: 50px">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><%DecimalFormat df = new DecimalFormat("##,###,###");%>
					<%=df.format(product.getUnitPrice())%></td>
				...
				<tr>
					...
					<th></th>
					<th>총액</th>
					<th><%DecimalFormat df = new DecimalFormat("##,###,###");%>
					<%=df.format(sum)%></th>
					<th></th>
				</tr>
			</table>
